...
[CreateAssetMenu(fileName = "DollAttributeData", menuName = "SO/DollAttributeData", order = 0)]
public class AttributeData :ScriptableObject
{
    public virtual Structs.CreatureAttribute ModifyAttribute(Structs.CreatureAttribute a)
    {
        return null;
    }
    public virtual Structs.CreatureAttribute CreateAttribute()
    {
        return null;
    }
}
public class DollAttributeData : AttributeData
{
    ...
    {
        Structs.DollAttribute attribute = new Structs.DollAttribute
        {
            isBackEnd = isBackEnd,
            ID = ID,
            hp = hp,
    ...
    {
        Structs.DollAttribute attribute = (Structs.DollAttribute)a;
