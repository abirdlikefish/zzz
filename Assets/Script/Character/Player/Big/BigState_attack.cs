...
public class BigState_attack : PlayerState
{
    private int _comboNum ;
    private bool _isFinished ;
    // private int _needComboNum ;
    public BigState_attack(PlayerStateMachine playerStateMachine , Enums.EPlayerState ePlayerState) : base(playerStateMachine , ePlayerState)
    {
        _comboNum = 0 ;
    }
